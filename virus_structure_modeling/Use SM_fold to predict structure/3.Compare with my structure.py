...
cmd = Visual.Plot_RNAStructure_Shape(seq[:300], dot_SM[:300], shape[:300])
print(cmd)

### 再看看3'UTR

cmd = Visual.Plot_RNAStructure_Shape(seq[29615:], dot_SM[29615:], shape[29615:])
print(cmd)
...
Structure.evaluate_dot(sars2_dot, dot)

# 有多少个公共的碱基对

ct1 = Structure.dot2ct(dot)
